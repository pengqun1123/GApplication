...
//                FileUtil.readFileToArray(file, bytes);
            ...
            //将已有的特征与模板进行比对
            MatchN matchN = matchFeature(match1_NFeature, waitMatchTemplData, myList, aimPath,
...
//            finger1N(myList, aimPath, handler, myMessage, myBundle);
    ...
    //将已有特征与模板比对
    private MatchN matchFeature(byte[] match1_NFeature, byte[] allWaitTempl, List<byte[]> allMatchTemplList
