...
public class TG661JFrontAPI {
    ...
    //SDK的当前版本号
    private static final String SDK_VERSION = "1.2.2_190719_Beta";
...
//        }
    ...
    public void delIDTemplDev(Handler handler, String datFileName, int templModelType) {
        ...
        if (TextUtils.isEmpty(datFileName)) {
            ...
            String fileName = datFileName.substring(0, datFileName.indexOf(".dat")).trim();
            this.templId = fileName.getBytes();
        }
        this.templModelType = templModelType;
    ...
    public void checkPermissions(int type) {
        for (String perm : perms) {
            ...
            if (checkResult == PackageManager.PERMISSION_DENIED) {
                ...
                bundle.putString("flag", Constant.TG661JFront);
...
//                            }
                    ...
                    case SET_DEV_MODEL:
                        ...
                        Log.d("===KKK","   设置模式的结果："+setDevModeRes1);
                        if (setDevModeRes1 == -1) {
                            int n = 0;
                            boolean loo = true;
                            while (loo) {
                    ...
                    case DEV_WORK_MODEL:
                        ...
                        Log.i("===KKK", "devWorkModelRes:" + devWorkModelRes + " value:" + ibr.getValue());
                    ...
                    case CONTINUE_VERIFY:
                        ...
                        Message continueVerifyMsg = new Message();
                    ...
                    case DEV_TEMPL_NUM:
                        ...
                        if (devTmplNumRes < 0) {
                            ...
                            if (type == 0 && devTmplNumRes >= 0) {
                                Log.d("===KKK", "  设备中已注册模板的数量：" + devTmplNumRes);
                                DevTemplNum = devTmplNumRes;
                                getDevTemplList(handler);
                            }
                            templNumMsg1.arg1 = devTmplNumRes;
            ...
            if (msg.what == RECEIVE_MESSAGE_CODE) {
                ...
                if (data != null) {
                    ...
                    if (devServiceArg == 0) {
                        tg661JMsg.arg1 = 1;
                        if (!isLink)
                            openDev(handler, mActivity, templModelType);
